...
(@) In particular, the following datasets are used from the SFR247:
    ...
    + [Subject studied](https://www.hesa.ac.uk/data-and-analysis/students/table-19#note)
    + [Region from](https://www.hesa.ac.uk/data-and-analysis/sfr247/figure-6)
    + [Postgraduate/Undergraduate figures](https://www.hesa.ac.uk/data-and-analysis/students/table-2)
    + [Sex](https://www.hesa.ac.uk/data-and-analysis/students/table-1)
    + [Size of full-time-equivalent (FTE) population](https://www.hesa.ac.uk/data-and-analysis/students/table-2)
    + [Under-represented group size](https://www.hesa.ac.uk/data-and-analysis/ukpis/widening-participation/table-t1)

(@) We will investigate the use of these data sources as potential *predictors* for the degree classification achieved by full-time students.
...
(@) The following people have influenced this report:
  ...
  + **Zachary Waller** | Git
  + **Calum Staff** | RAP
  + **David Goody and Salman Kasim** | Web-scraping
