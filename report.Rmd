...
(@) Checking for *representativeness*, we see that our four parallel chains run generally overlap each other for each $\beta$ parameter (the four colours of blue, green, red and black can be faintly seen), so our chains fulfil this condition.
