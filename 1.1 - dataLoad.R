...
data_list <- list()
len(data_list) <- 5
data_list[[1]] <- read_csv(file = 'Data/he_enrolment_by_provider.csv', col_names = TRUE, skip = 12)
data_list[[2]] <- read_csv(file = 'Data/he_qualifiers_by_provider.csv', col_names = TRUE, skip = 12)
data_list[[3]] <- read_csv(file = 'Data/he_subject_by_provider.csv', col_names = TRUE, skip = 14)
data_list[[4]] <- read_csv(file = 'Data/he_urp_by_provider.csv', col_names = TRUE, skip = 12)
